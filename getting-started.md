...
You can start out by using the EXOTIC program to run transits. First, you will have to downlaod imaging software to view the images. Please see the recording and slides from the first meeting for more background.
